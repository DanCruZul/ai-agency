...
export default function TermsPage() {
  return (
    <LegalLayout>
      <LegalHeader title="Terms of Service" lastUpdated="April 15, 2024" />

      <LegalSection title="Agreement to Terms">
        <p>
          By accessing or using AI Platform, you agree to be bound by these
      ...
      <LegalSection title="Restrictions">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            Use the materials for commercial purposes without a subscription
          </li>
